...
// Dynamically import Countdown with SSR disabled to ensure it only runs on the client
// and avoids any hydration mismatches with the server-side AuthLayout.
      ...
      <div className="relative hidden overflow-hidden bg-primary lg:block">
        ...
        <div className="relative flex h-full flex-col justify-end p-14">
          <div className="mb-8 min-h-[60px]">
            ...
            <span className="mb-2 block text-[10px] font-bold uppercase tracking-widest text-white/50">
              LAUNCH DATE — 13 OCT 2026
            </span>
            <Countdown dark />
          </div>
          <p className="text-display-lg text-on-primary">
            Command every part of Havenly Solutions from one place.
          </p>
