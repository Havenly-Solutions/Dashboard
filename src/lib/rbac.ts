...
export const NAV_MODULES: NavModule[] = [
  ...
  { key: "helpdesk", label: "Helpdesk", href: "/helpdesk", icon: "support-agent", roles: ["FOUNDER", "MANAGER"], group: "Operations" },
  { key: "support", label: "Customer Support", href: "/support", icon: "forum", roles: ["FOUNDER", "CO_FOUNDER", "MANAGER"], group: "Operations" },
  { key: "security", label: "Security Suite", href: "/security/campaigns", icon: "shield", roles: ["FOUNDER", "DEVELOPER"], group: "Operations" },
  { key: "comms", label: "Comms Hub", href: "/comms", icon: "chat", roles: ["FOUNDER", "CO_FOUNDER", "MANAGER"], group: "Operations" },
