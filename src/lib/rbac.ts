...
export const ROLE_LABELS: Record<Role, string> = {
  ...
  MANAGER: "Manager",
  MANAGER_VIDEOGRAPHER: "Videographer Manager",
  MANAGER_CONTENT_CREATOR: "Content Creator Manager",
  DEVELOPER: "Developer",
...
export const PORTALS: PortalInfo[] = [
  ...
  { role: "MANAGER_VIDEOGRAPHER", name: "Videographer Portal", homeHref: "/manager-portal/videographer", tagline: "Media operations \u2014 videographer department." },
  { role: "MANAGER_CONTENT_CREATOR", name: "Content Creator Portal", homeHref: "/manager-portal/content-creator", tagline: "Media operations \u2014 content creator department." },
  { role: "DEVELOPER", name: "Developer Portal", homeHref: "/developer-portal", tagline: "Technical \u2014 app health, security, infrastructure." },
  { role: "CYBERSECURITY", name: "Cybersecurity Portal", homeHref: "/cybersecurity-portal", tagline: "Security operations \u2014 audit logs and breach monitoring." },
  { role: "MEDIA", name: "Media Portal", homeHref: "/media-portal", tagline: "Production \u2014 assets, B-roll, and final edits." },
...
export const NAV_MODULES: NavModule[] = [
  ...
  { key: "manager-portal", label: "Manager Portal", href: "/manager-portal", icon: "dashboard", roles: ["MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR"], group: "Command", hideFromNav: true },
  ...
  { key: "cybersecurity-portal", label: "Cybersecurity Portal", href: "/cybersecurity-portal", icon: "dashboard", roles: ["CYBERSECURITY"], group: "Command", hideFromNav: true },
  { key: "media-portal", label: "Media Portal", href: "/media-portal", icon: "dashboard", roles: ["MEDIA"], group: "Command", hideFromNav: true },
  ...
  { key: "sos", label: "Live SOS Command", href: "/sos", icon: "emergency", roles: ["FOUNDER", "MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR"], group: "Command" },
  ...
  { key: "helpdesk", label: "Helpdesk", href: "/helpdesk", icon: "support-agent", roles: ["FOUNDER", "MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR"], group: "Operations" },
  { key: "support", label: "Customer Support", href: "/support", icon: "forum", roles: ["FOUNDER", "CO_FOUNDER", "MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR"], group: "Operations" },
  { key: "security", label: "Security Suite", href: "/security/campaigns", icon: "shield", roles: ["FOUNDER", "DEVELOPER"], group: "Operations" },
  { key: "comms", label: "Comms Hub", href: "/comms", icon: "chat", roles: ["FOUNDER", "CO_FOUNDER", "MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR"], group: "Operations" },
  ...
  { key: "partners", label: "Partners & NGOs", href: "/partners", icon: "handshake", roles: ["FOUNDER", "CO_FOUNDER", "MANAGER", "MANAGER_VIDEOGRAPHER", "MANAGER_CONTENT_CREATOR", "NGO_PARTNER"], group: "Organization" },
  { key: "help", label: "Help & Support", href: "/help", icon: "support-agent", roles: ROLES, group: "Organization" },
